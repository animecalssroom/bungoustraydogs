...
import { CaseFileWrapper, CaseSection } from '@/frontend/components/archive/CaseFileWrapper'

const RESERVED_SLUGS = ['mori-ogai', 'fukuzawa-yukichi', 'fyodor-dostoyevsky', 'fitzgerald', 'dazai-osamu']
      ...
      <div className={styles.caseWrap}>
        ...
        <CaseFileWrapper>
          <article className={styles.caseFile}>
            <div className="absolute top-0 right-0 p-8 pointer-events-none opacity-[0.03] select-none text-9xl font-cinzel">
              {factionMeta.kanji}
            </div>
            
            <header className={styles.caseHeader}>
              <div>
                <p className={styles.caseMeta}>Special Division Registry</p>
                <h1 className={styles.caseNumber}>{getArchiveCaseNumber(entry.slug)}</h1>
              </div>
              <div className={styles.caseKanji}>{factionMeta.kanji}</div>
            </header>

            <CaseSection delay={0.1}>
